...
3. 基础Pydantic schemas
   - [ ] `backend/schemas/session.py` - TeachingSession
   - [ ] `backend/schemas/session.py` - StudentProfile, StudentCreateRequest
   - [ ] `backend/schemas/session.py` - Message, MessageType
